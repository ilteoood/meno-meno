...
export const V1_FIXTURE_SOURCES: readonly V1FixtureSource[] = [
  ...
  { operatore: 'eolo', commodity: 'fisso', url: 'https://www.eolo.it/', playwright: false },
  ...
  { operatore: 'sorgenia', commodity: 'luce', url: 'https://www.sorgenia.it/sites/default/themes/sorgenia/modules/preprod_dynamic_card.php?offert=43124&commodity=ELE&consume=medium', playwright: false },
  { operatore: 'illumia', commodity: 'luce', url: 'https://www.illumia.it/casa/luce/', playwright: false },
  ...
  { operatore: 'windtre', commodity: 'fisso', url: 'https://www.windtre.it/offerte-fibra', playwright: true },
  ...
  { operatore: 'iliad', commodity: 'fisso', url: 'https://www.iliad.it/offerte-iliad-fibra.html', playwright: false },
  ...
  { operatore: 'skywifi', commodity: 'fisso', url: 'https://www.sky.it/sky-wifi-fibra', playwright: false },
  ...
  { operatore: 'linkem', commodity: 'fisso', url: 'https://www.linkem.com/', playwright: true },
];