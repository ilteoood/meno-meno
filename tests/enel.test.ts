...
test('EnelLuceScraper parses fixture HTML into offerte', async () => {
  ...
  const fix = result.offerte.find((o) => o.nome_commerciale === 'Enel Fix Web Luce');
  assert.ok(fix, 'expected Enel Fix Web Luce offer');
